...
#[allow(non_camel_case_types)]
/// Extension trait for query builder access to the table `TNode`.
///
/// Implemented for [`__sdk::QueryTableAccessor`].
pub trait nodes_worldQueryTableAccess {
    #[allow(non_snake_case)]
    /// Get a query builder for the table `TNode`.
    fn nodes_world(&self) -> __sdk::__query_builder::Table<TNode>;
}

impl nodes_worldQueryTableAccess for __sdk::QueryTableAccessor {
    fn nodes_world(&self) -> __sdk::__query_builder::Table<TNode> {
        __sdk::__query_builder::Table::new("nodes_world")
    }
}
