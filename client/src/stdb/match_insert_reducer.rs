...
pub trait match_insert {
    ...
    /// /// Use [`match_insert:match_insert_then`] to run a callback after the reducer completes.
    fn match_insert(&self) -> __sdk::Result<()> {
        self.match_insert_then(|_, _| {})
    }
...
impl match_insert for super::RemoteReducers {
    fn match_insert_then(
        ...
        self.imp
            .invoke_reducer_with_callback(MatchInsertArgs {}, callback)
    }
}
