...
pub trait sync_assets {
    ...
    fn sync_assets(&self, global_settings: GlobalSettings, nodes: String) -> __sdk::Result<()>;
    ...
    fn on_sync_assets(
        &self,
        callback: impl FnMut(&super::ReducerEventContext, &GlobalSettings, &String) + Send + 'static,
...
impl sync_assets for super::RemoteReducers {
    ...
    fn on_sync_assets(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &GlobalSettings, &String) + Send + 'static,
    ) -> SyncAssetsCallbackId {
        SyncAssetsCallbackId(self.imp.on_reducer(
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                callback(ctx, global_settings, nodes)
            }),
        ))
    }
    fn remove_on_sync_assets(&self, callback: SyncAssetsCallbackId) {
