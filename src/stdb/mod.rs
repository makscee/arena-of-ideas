...
match table_name {
						"GlobalData" => client_cache.handle_table_update_no_primary_key::<global_data::GlobalData>(callbacks, table_update),
			"GlobalSettings" => client_cache.handle_table_update_no_primary_key::<global_settings::GlobalSettings>(callbacks, table_update),
			"TAbility" => client_cache.handle_table_update_with_primary_key::<t_ability::TAbility>(callbacks, table_update),
			"TArenaLeaderboard" => client_cache.handle_table_update_no_primary_key::<t_arena_leaderboard::TArenaLeaderboard>(callbacks, table_update),
			"TArenaPool" => client_cache.handle_table_update_with_primary_key::<t_arena_pool::TArenaPool>(callbacks, table_update),
			"TArenaRun" => client_cache.handle_table_update_with_primary_key::<t_arena_run::TArenaRun>(callbacks, table_update),
			"TArenaRunArchive" => client_cache.handle_table_update_with_primary_key::<t_arena_run_archive::TArenaRunArchive>(callbacks, table_update),
			"TBaseUnit" => client_cache.handle_table_update_with_primary_key::<t_base_unit::TBaseUnit>(callbacks, table_update),
			"TBattle" => client_cache.handle_table_update_with_primary_key::<t_battle::TBattle>(callbacks, table_update),
			"THouse" => client_cache.handle_table_update_with_primary_key::<t_house::THouse>(callbacks, table_update),
			"TRepresentation" => client_cache.handle_table_update_no_primary_key::<t_representation::TRepresentation>(callbacks, table_update),
			"TStatus" => client_cache.handle_table_update_with_primary_key::<t_status::TStatus>(callbacks, table_update),
			"TTeam" => client_cache.handle_table_update_with_primary_key::<t_team::TTeam>(callbacks, table_update),
			"TUser" => client_cache.handle_table_update_with_primary_key::<t_user::TUser>(callbacks, table_update),
...
fn invoke_row_callbacks(&self, reminders: &mut RowCallbackReminders, worker: &mut DbCallbacks, reducer_event: Option<Arc<AnyReducerEvent>>, state: &Arc<ClientCache>) {
		...
		reminders.invoke_callbacks::<global_settings::GlobalSettings>(worker, &reducer_event, state);
		reminders.invoke_callbacks::<t_ability::TAbility>(worker, &reducer_event, state);
		reminders.invoke_callbacks::<t_arena_leaderboard::TArenaLeaderboard>(worker, &reducer_event, state);
		...
		reminders.invoke_callbacks::<t_arena_run_archive::TArenaRunArchive>(worker, &reducer_event, state);
		...
		reminders.invoke_callbacks::<t_representation::TRepresentation>(worker, &reducer_event, state);
...
match table_name {
						"GlobalData" => client_cache.handle_resubscribe_for_type::<global_data::GlobalData>(callbacks, new_subs),
			"GlobalSettings" => client_cache.handle_resubscribe_for_type::<global_settings::GlobalSettings>(callbacks, new_subs),
			"TAbility" => client_cache.handle_resubscribe_for_type::<t_ability::TAbility>(callbacks, new_subs),
			"TArenaLeaderboard" => client_cache.handle_resubscribe_for_type::<t_arena_leaderboard::TArenaLeaderboard>(callbacks, new_subs),
			"TArenaPool" => client_cache.handle_resubscribe_for_type::<t_arena_pool::TArenaPool>(callbacks, new_subs),
			"TArenaRun" => client_cache.handle_resubscribe_for_type::<t_arena_run::TArenaRun>(callbacks, new_subs),
			"TArenaRunArchive" => client_cache.handle_resubscribe_for_type::<t_arena_run_archive::TArenaRunArchive>(callbacks, new_subs),
			"TBaseUnit" => client_cache.handle_resubscribe_for_type::<t_base_unit::TBaseUnit>(callbacks, new_subs),
			"TBattle" => client_cache.handle_resubscribe_for_type::<t_battle::TBattle>(callbacks, new_subs),
			"THouse" => client_cache.handle_resubscribe_for_type::<t_house::THouse>(callbacks, new_subs),
			"TRepresentation" => client_cache.handle_resubscribe_for_type::<t_representation::TRepresentation>(callbacks, new_subs),
			"TStatus" => client_cache.handle_resubscribe_for_type::<t_status::TStatus>(callbacks, new_subs),
			"TTeam" => client_cache.handle_resubscribe_for_type::<t_team::TTeam>(callbacks, new_subs),
			"TUser" => client_cache.handle_resubscribe_for_type::<t_user::TUser>(callbacks, new_subs),
			_ => spacetimedb_sdk::log::error!("TableRowOperation on unknown table {:?}", table_name),
}
}
}
